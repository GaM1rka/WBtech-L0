...
## Миграции
Миграции добавлены docker-compose.yml файле. При запуске автоматически происходит накат миграций. Чтобы откатить миграции нужно ввести:
``` bash
